...
`preserve_thinking: true` est **essentiel** pour les modèles avec mode réflexion (comme Qwen3). Sans ça, le contenu de réflexion est silencieusement supprimé dans les réponses API.
